...
def _add_common_args(arg_parser):
    ...
    arg_parser.add_argument('--model_type', type=str, default="trimf", help="Type of model")
    ...
    arg_parser.add_argument('--device_id', type=str, default="0",
                            help="gpu device id")
    ...
    arg_parser.add_argument('--prop_drop', type=float, default=0.1, help="Probability of dropout used in TriMF")
    ...
    arg_parser.add_argument('--syn_graph', action='store_true', default=False, help="")
    arg_parser.add_argument('--sema_graph', action='store_true', default=False, help="")
    arg_parser.add_argument('--fusion_rgcn', action='store_true', default=False, help="")
    arg_parser.add_argument('--tw_rel_atten_token', action='store_true', default=False, help="")
    arg_parser.add_argument('--tw_ent_atten_token', action='store_true', default=False, help="")
    arg_parser.add_argument('--tw_rel_atten_subword', action='store_true', default=False, help="")
    arg_parser.add_argument('--tw_ent_atten_subword', action='store_true', default=False, help="")
    arg_parser.add_argument('--trigger_attn', action='store_true', default=False, help="")
...
def train_argparser():
    ...
    arg_parser.add_argument('--full_graph_retain_rate', type=float, default=0.8, help="")
    arg_parser.add_argument('--dt_graph_retain_rate', type=float, default=0.8, help="")
    arg_parser.add_argument('--tw_grad_flow_token', action='store_true', default=False, help="")
    arg_parser.add_argument('--tw_grad_flow_subword', action='store_true', default=False, help="")
    arg_parser.add_argument('--trigger_grad_flow', action='store_true', default=False, help="")
    
    arg_parser.add_argument('--split_epoch', type=int, default=18, help="")
